...
//        
//        return self.musicVM.favAlbums.count
//    }
//    
...
//        
//        cell.itunesTitle.text = musicVM.favAlbums[indexPath.row].albumname
//        cell.itunesAuthor.text = musicVM.favAlbums[indexPath.row].artistname
//
//        
//        guard let img = musicVM.favAlbums[indexPath.row].picture else { return UITableViewCell()} // the auto fix wanted to include !=
//        self.musicVM.bind{
//            DispatchQueue.main.async {
//                self.FavTable.reloadData()
//            }
